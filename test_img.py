...
tif_gaussian_noised_image = gaussianNoise(tif_src)
tif_missing_line_noised_image = missingLineNoise(tif_src)
tif_salt_pepper_noised_image = saltPepperNoise(tif_src)
tif_poisson_noised_image = poissonNoise(tif_src)
tif_striping_noised_image = stripingNoise(tif_src)
...
tif_striping_denoised_image = stripe(tif_striping_noised_image)
